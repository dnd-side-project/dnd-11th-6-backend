...
public class SnapService {
    ...
    public CreateSnapResponseDto createSimpleSnap(Long meetingId, Long participantId, MultipartFile file, LocalDateTime shootDate) {
        ...
        Snap snap = SimpleSnap.create(url, shootDate, meeting, participant);
